...
INPUT_FILE = "oxford_phrases_detailed.json"
OUTPUT_FILE = "oxford_phrases_translated.json"
...
def main():
    ...
    print(f"Loaded {total_words} phrases to translate.")
